...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Greek","Hindi","Kannada","Marathi","Tamil","Telugu","Welsh","Urdu"};
    String[] toLanguages = {"To","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Greek","Hindi","Kannada","Marathi","Tamil","Telugu","Welsh","Urdu"};
